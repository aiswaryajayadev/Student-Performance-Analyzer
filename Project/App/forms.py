...
from App.models import Courses,SessionYearModel, Subjects
...
class AddStudentForm(forms.Form):
    ...
    phonenumber = forms.CharField(label="Phone Nomber", max_length=10, widget=forms.NumberInput(attrs={"class": "form-control"}))
    sem = forms.CharField(label="Semester", max_length=50, widget=forms.TextInput(attrs={"class": "form-control"}))
    course_list = []
    try:
    ...
    session_year_id = forms.ChoiceField(label="Academic Year", choices=session_list,widget=forms.Select(attrs={"class": "form-control"}))
...
class EditStudentForm(forms.Form):
    ...
    username=forms.CharField(label="Username",max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
    address=forms.CharField(label="Address",max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
    sem = forms.CharField(label="Semister No.", max_length=50, widget=forms.TextInput(attrs={"class": "form-control"}))
...
class EditResultForm(forms.Form):
    ...
    session_ids=forms.ChoiceField(label="Academic Year",choices=session_list,widget=forms.Select(attrs={"class":"form-control"}))

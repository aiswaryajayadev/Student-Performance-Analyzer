    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(default=0, max_length=10, validators=[django.core.validators.RegexValidator('^\\+?1?\\d{9,15}$', 'Enter a valid phone number.')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_years', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App.sessionyearmodel')),
                ('started_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App.staffs')),
